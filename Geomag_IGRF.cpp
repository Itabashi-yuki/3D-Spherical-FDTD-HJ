...
Eigen::Vector3d transform_geomag(double Inc, double Dec, double th, double ph){
    ...
    AndoLab::Vector3d <double> nR_T(1.0, (90.0 - Tx_Longitude)*AndoLab::DEG2RAD, Tx_Latitude*AndoLab::DEG2RAD, AndoLab::coordinate::Spherical);
    AndoLab::Vector3d <double> nR_R(1.0, (90.0 - Rx_Longitude)*AndoLab::DEG2RAD, Rx_Latitude*AndoLab::DEG2RAD, AndoLab::coordinate::Spherical);
    ...
    = -std::sin(Inc) * R_v - std::cos(Inc) * std::cos(Dec) * Th_v + std::cos(Inc) * std::sin(Dec) * Ph_v;
