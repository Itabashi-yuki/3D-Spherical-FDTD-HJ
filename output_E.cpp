...
void output_E(double ***Er, double ****Eth, double ****Eph, double ***Hr, double ****Hth, double ****Hph, int n, int n0){
    ...
    if(n == 1 || n % n0 == 0 || n == Nt - 1){
        std::ofstream ofs_E_thph("./data/" + global_dirName + "/Ethph_" + std::to_string(n) + ".dat");
        std::ofstream ofs_E_rth("./data/" + global_dirName + "/Erth_" + std::to_string(n) + ".dat");
        std::ofstream ofs_E_rph("./data/" + global_dirName + "/Erph_" + std::to_string(n) + ".dat");
